<template>
  ...
  <div class="mx-20 mb-8 mt-5">
    ...
    <p class="text-justify">
      ...
      détaillé du réseau à mettre en place et réalisé un cahier des charges avec
      les temps estimés de réalisation et le niveau de difficulté selon nos
      aises.
      <br />
      La première maquette consistait à créer les 2 sites avec lequel on allait
      installer notre infrastructure: un site principal et secondaire. Dans ces
      2 sites se trouvaient 2 serveurs Active Directory, chacun avec des
      services différents. Nous avons également du gérer les GPO et les
      ...
      déployés sur les serveurs en interne. Enfin, nous avons du configurer une
      connexion Vpn site-à-site IPSec.
      <br />
      ...
      Un VPN nomade est configuré. A la fin du projet, il est possible après une
      connexion par VPN d'accéder au réseau interne depuis l'extérieur.
    </p>
    <br />
